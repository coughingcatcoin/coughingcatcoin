...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/coughingcatcoin.ico %{buildroot}%{_datadir}/pixmaps/coughingcatcoin.ico
install -p share/pixmaps/nsis-header.bmp %{buildroot}%{_datadir}/pixmaps/
install -p share/pixmaps/nsis-wizard.bmp %{buildroot}%{_datadir}/pixmaps/
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/bitcoin.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/coughingcatcoin16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/coughingcatcoin32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/coughingcatcoin64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/coughingcatcoin128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/coughingcatcoin256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/coughingcatcoin256.png %{buildroot}%{_datadir}/pixmaps/coughingcatcoin16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/coughingcatcoin256.png %{buildroot}%{_datadir}/pixmaps/coughingcatcoin32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/coughingcatcoin256.png %{buildroot}%{_datadir}/pixmaps/coughingcatcoin64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/coughingcatcoin256.png %{buildroot}%{_datadir}/pixmaps/coughingcatcoin128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/coughingcatcoin256.png %{buildroot}%{_datadir}/pixmaps/coughingcatcoin256.xpm
...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 34902
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 34902
