# Installing Coughingcatcoin Core

### Pre-compiled binaries

The easiest way to install the latest version of the Coughingcatcoin Core software is
by to download the latest precompiled binaries for your platform from the
[release page](https://github.com/coughingcatcoin/coughingcatcoin/releases). Currently,
...
It is possible to build your own copy of Coughingcatcoin Core with the exact, tested,
dependencies, as used for the binary releases, by using the
[depends system](depends/description.md). Please refer to the
[depends README](depends/README.md) for instructions to build Coughingcatcoin using
these dependencies.

### Compiling using system-provided libraries

  The following are developer notes on how to build Coughingcatcoin on your native
  ...
  - [macOS Build Notes](doc/Building-Coughingcatcoin-1.14-for-Mac.md)
...
Run with the `-testnet` option to run with "play coughingcatcoins" on the test network, if you
...
Coughingcatcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
