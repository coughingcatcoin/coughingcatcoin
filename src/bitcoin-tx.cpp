...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s coughingcatcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  coughingcatcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coughingcatcoin transaction") + "\n" +
              "  coughingcatcoin-tx [options] -create [commands]   " + _("Create hex-encoded coughingcatcoin transaction") + "\n" +
              "\n";
