...
void SendCoinsDialog::updateFeeSectionControls()
{
    ...
    //mlumin: 5/2021 - this label actually gates the 'slider and smart fee' functionality, so turn it off for coughingcatcoin.
...
void SendCoinsDialog::updateGlobalFeeVariables()
{
    if (ui->radioSmartFee->isChecked())
    {
        ...
        // Coughingcatcoin: We manually set height well past the last hard fork here
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Coughingcatcoin address"));
        }
        else // Valid address
        {
            CKeyID keyid;
