...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, checkout Coughingcatcoin repository on GitHub!"),
        tr("Services that claim to double your coughingcatcoins are always ponzi schemes")
    };
