...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Coughingcatcoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Coughingcatcoin (as there is no actual maximum coins)
