...
UniValue getpeerinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw runtime_error(
            ...
            "    \"feefilter\": \"decimal\",  (string)  The value of the last feefilter set by this peer, in CCT\n"
...
UniValue addnode(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2 ||
        ...
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("addnode", "\"192.168.0.6:34701\" \"onetry\"")
            + HelpExampleRpc("addnode", "\"192.168.0.6:34701\", \"onetry\"")
        );
...
UniValue disconnectnode(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("disconnectnode", "\"192.168.0.6:34701\"")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:34701\"")
        );
...
UniValue getaddednodeinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw runtime_error(
            ...
            "       {\n"
            "         \"address\" : \"192.168.0.201:34701\", (string) The coughingcatcoin server IP and port we're connected to\n"
