...
{
    const char* pszTimestamp = "ultra morning";
    const CScript genesisOutputScript = CScript() << ParseHex("04665c98d5ebf3268d5545f0142a343208776078ef11e9065570b7445deefce313846955a0bb800d4acc3e7ae6fb019fc32339b5837ecfa16a79a36d001a4c3f00") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nMajorityEnforceBlockUpgrade = 0;
        consensus.nMajorityRejectBlockOutdated = 0;
        consensus.nMajorityWindow = 0;
        // BIP34 is never enforced in Zogecoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to Zogecoin values
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000001dceda12c0");
        ...
        vAlertPubKey = ParseHex("04476de09a3e9d9c8d15c122367eb01fc22c2452cd981fec159b668aa43f6e30023c1fcc16a00fed9b0d2286519fda623b20749999758717d403a3325adf5b7054");
        nDefaultPort = 34701;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1631496808, 1415664, 0x1e0ffff0, 1, 50 * COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        assert(consensus.hashGenesisBlock == uint256S("0xb0cd68e27450f95c654a1bb7fed054ae62aa0217ea0313c6eb8bc96eb5d54ea8"));
        assert(genesis.hashMerkleRoot == uint256S("0x4acb306cd188111d4c8143787520ef9595c6818a9e3fcac3a3932124ddaec2c0"));
        ...
        vSeeds.push_back(CDNSSeedData("DNS seed", "31.14.41.241"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (       0, uint256S("0xb0cd68e27450f95c654a1bb7fed054ae62aa0217ea0313c6eb8bc96eb5d54ea8"))
            (   40000, uint256S("0x4ed660f0047b5480f8f61bcecb532b34436de7ac5cfbfe3247659c764bb06ab4"))
        };
        ...
        chainTxData = ChainTxData{
            ...
            1635620488, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1631497995, 11822, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        minDifficultyConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        assert(consensus.hashGenesisBlock == uint256S("0x0c0f87ff91760e4a7157f6ec88a9cf6627f5eed067a74164a4656286225bf952"));
        assert(genesis.hashMerkleRoot == uint256S("0x4acb306cd188111d4c8143787520ef9595c6818a9e3fcac3a3932124ddaec2c0"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,87); // 0x71
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x0c0f87ff91760e4a7157f6ec88a9cf6627f5eed067a74164a4656286225bf952"))
        };

        chainTxData = ChainTxData{
            // Data as of block 07fef07a255d510297c9189dc96da5f4e41a8184bc979df8294487f07fee1cf3 (height 3286675)
            1631497995, // * UNIX timestamp of last checkpoint block
...
public:
    CRegTestParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,87);  // 0x6f
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,196);  // 0xc4
