...
void Shutdown()
{
    ...
    RenameThread("coughingcatcoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Coughingcatcoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/coughingcatcoin/coughingcatcoin>";
    const std::string URL_WEBSITE = "<https://coughingcat.com>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("coughingcatcoin-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Coughingcatcoin version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Coughingcatcoin: Do we need to do any RPC mining init here?
